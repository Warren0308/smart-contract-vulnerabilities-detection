...
# Example usage
folder_path = 'Data Collection/Operation_code/sol/'  # Replace with your folder path
csv_file_path = 'Data Collection/contracts.csv'  # Replace with your CSV file path
